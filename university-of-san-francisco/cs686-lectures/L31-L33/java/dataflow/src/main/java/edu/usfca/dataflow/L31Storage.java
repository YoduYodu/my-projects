...
public class L31Storage {

  static List<String> allBadv = Arrays.asList("Lorem", "ipsum", "dolor", "sit", "amet,", "consectetur", "adipiscing",
  ...
  static List<String> allBapp = Arrays.asList("Velit", "sed", "ullamcorper", "morbi", "tincidunt", "ornare.", "At",
      "auctor", "urna", "nunc", "id", "cursus", "metus", "aliquam", "eleifend", "mi.", "Sit", "amet", "facilisis",
      "magna", "etiam", "tempor", "orci", "eu.", "Praesent", "elementum", "facilisis", "leo", "vel", "fringilla", "est",
      "ullamcorper", "eget", "nulla.", "Ac", "turpis", "egestas", "integer", "eget", "aliquet", "nibh", "praesent.",
      "A", "diam", "sollicitudin", "tempor", "id", "eu", "nisl", "nunc", "mi", "ipsum.", "Sed", "viverra", "ipsum",
      "nunc", "aliquet", "bibendum", "enim", "facilisis.", "Nulla", "aliquet", "porttitor", "lacus", "luctus.", "Sed",
  ...
  static List<String> allBcat = Arrays.asList("Morbi", "tincidunt", "augue", "interdum", "velit", "euismod", "in",
      "pellentesque.", "Ut", "etiam", "sit", "amet", "nisl", "purus", "in", "mollis", "nunc", "sed.", "Laoreet", "sit",
      "amet", "cursus", "sit", "amet", "dictum.", "Sapien", "et", "ligula", "ullamcorper", "malesuada", "proin",
      "libero", "nunc", "consequat", "interdum.", "Orci", "porta", "non", "pulvinar", "neque.", "Egestas", "dui", "id",
      ...
      "aliquam", "faucibus", "purus", "in.", "Amet", "est", "placerat", "in", "egestas.", "Nec", "sagittis", "aliquam",
      "malesuada", "bibendum", "arcu", "vitae.", "Cursus", "eget", "nunc", "scelerisque", "viverra", "mauris", "in",
      "aliquam", "sem", "fringilla.", "Morbi", "tristique", "senectus", "et", "netus", "et", "malesuada", "fames",
      "ac.", "Risus", "pretium", "quam", "vulputate", "dignissim", "suspendisse", "in", "est", "ante.", "Massa",
      "placerat", "duis", "ultricies", "lacus", "sed", "turpis.", "Facilisi", "morbi", "tempus", "iaculis", "urna",
      "id", "volutpat", "lacus.", "Massa", "tempor", "nec", "feugiat", "nisl.");

  static List<String> allCur =
      Arrays.asList("6bc2af68-ee7d-4afc-ac5c-d8727fed2309", "e657bc60-9575-499a-bd46-e4b48364e45c",
   ...
   *
   * -rw-r--r-- 1 haden staff 42110 Mar 24 22:45 base64-00000-of-00001.txt
   *
   * -rw-r--r-- 1 haden staff 14698 Mar 24 22:45 base64-00000-of-00001.txt.gz
   *
   * -rw-r--r-- 1 haden staff 31723 Mar 24 22:45 tfrecord-00000-of-00001.bin
   * 
  ...
  public static void executeSampleCode() throws InvalidProtocolBufferException {
    ...
    pc.apply(MapElements.into(TypeDescriptors.strings()).via((byte[] x) -> Base64.getEncoder().encodeToString(x)))
        .apply(TextIO.write().to("dataflow/resources/L31/base64").withNumShards(1).withSuffix(".txt"));

    // Write to binary files using TFRecord.
    pc.apply(TFRecordIO.write().to("dataflow/resources/L31/tfrecord").withNumShards(1).withSuffix(".bin"));

    // repeat, with compression.
    // Write to plain-text files (line-delimited) using B64 encoding.
    pc.apply(MapElements.into(TypeDescriptors.strings()).via((byte[] x) -> Base64.getEncoder().encodeToString(x)))
        .apply(TextIO.write().to("dataflow/resources/L31/base64").withCompression(Compression.GZIP).withNumShards(1)
            .withSuffix(".txt"));

    // Write to binary files using TFRecord.
    pc.apply(TFRecordIO.write().to("dataflow/resources/L31/tfrecord").withCompression(Compression.GZIP).withNumShards(1)
        .withSuffix(".bin"));
